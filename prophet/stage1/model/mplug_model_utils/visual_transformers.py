...
def initialize_clip(__C, num_patches=240):
    #from mplug_model_utils.clip import clip
    from .clip import clip
    clip_model, preprocess = clip.load(__C.clip_path, jit=False)
    num_patches = int(__C.image_res*__C.image_res/(14*14))
